    ...
    <footer className={cn('bg-white border-t border-gray-200 mt-auto', className)}>
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">July24Academy</h3>
            <p className="text-gray-600 text-sm">
              Adaptive learning platform for mathematics with personalized lessons and practice.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/courses" className="text-gray-600 hover:text-blue-600 text-sm">
                  Courses
                </a>
              </li>
              <li>
                <a href="/pedagogy" className="text-gray-600 hover:text-blue-600 text-sm">
                  Pedagogy
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/blog" className="text-gray-600 hover:text-blue-600 text-sm">
                  Blog
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/careers" className="text-gray-600 hover:text-blue-600 text-sm">
                  Careers
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <p className="text-gray-500 text-sm text-center">
            &copy; {new Date().getFullYear()} July24Academy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
